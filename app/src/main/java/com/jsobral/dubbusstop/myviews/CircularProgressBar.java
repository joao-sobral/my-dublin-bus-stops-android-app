package com.jsobral.dubbusstop.myviews;
...
/**
 * Created by Mikhael LOPEZ on 16/10/2015. Customized by Joao Sobral on Feb 7, 2017 (added title and subtitle)
 */
public class CircularProgressBar extends View {
    //Title stuff
    private String mTitle = "title";
    private String mSubTitle = "subT";
    private final Paint mTitlePaint = new Paint();
    private final Paint mSubtitlePaint = new Paint();

    //set title and subtitle colors
    private int myTitleColor = Color.rgb(0,102,255);
    private int mySubTitleColor= Color.rgb(179,83,0);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTitlePaint.setColor(myTitleColor);
        mSubtitlePaint.setColor(mySubTitleColor);
